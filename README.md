# Maître de Maison — App Android (Espace Maître)

Coquille Android légère (Capacitor) qui affiche directement ton site déjà en
ligne (`maitre-de-maison-1.onrender.com/espace-maitre-web.html`). Pas de
...
3. Une fois terminé (coche verte ✓), descends en bas de la page → section
   **Artifacts** → clique sur **maitre-de-maison-maitre-apk** pour le
...
- **appId** (`com.maitredemaison.maitre`) : identifiant unique de l'app,
